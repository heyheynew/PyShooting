...
trashImage = ['./trash/trash01.png', './trash/trash02.png', './trash/trash03.png', './trash/trash04.png', './trash/trash05.png', \
             './trash/trash06.png', './trash/trash07.png', './trash/trash08.png', '/trash/trash09.png', './trash/trash10.png', \
...
fishImage2 = ['./fish/fish01.png', './fish/fish02.png', './fish/fish03.png', './fish/fish04.png', './fish/fish05.png', \
             ...
             './fish/fish11.png', './fish/fish12.png', './fish/fish13.png', './fish/fish14.png', './fish/fish15.png', \
             './fish/fish16.png'] 
sharkImage = ['./img/shark.png']
shark2Image = ['./img/shark2.png']
...
titleImg = pygame.image.load("./img/게임이름.png")
normalImg = pygame.image.load("./img/normal.png")
hardImg = pygame.image.load("./img/hard.png")
clicknormalImg = pygame.image.load("./img/normal.png")
clickhardImg = pygame.image.load("./img/hard.png")
restartImg = pygame.image.load("./img/재시작.png")
menuImg = pygame.image.load("./img/메뉴.png")
...
def initGame():
    ...
    fighter = pygame.image.load('./img/diver.png')                   # 사람 그림
    missile = pygame.image.load('./img/net.png')                     # 그물 그림
    bignet = pygame.image.load('./img/bignet.png')                   # 필살기 그림
    plus = pygame.image.load('./img/+.png')                          # +100 그림
    minus = pygame.image.load('./img/-.png')                         # -100 그림
